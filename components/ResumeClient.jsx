...
const experience = {
  ...
  items: [
    ...
    },
    {
      ...
      position: "Software Engineer & Research Assistance",
...
const education = {
  ...
  items: [
    ...
    {
      institution: "University of Wisconsin - Madison",
      degree: "Certificate in Mathematics",
      duration: "September 2019 – August 2025",
    },
  ],
};
  ...
  skillList: [
    ...
    },
    {
      icon: (
        <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center">
          <img
            src="https://raw.githubusercontent.com/ros-infrastructure/artwork/master/ros_logo.svg"
            alt="ROS"
            className="w-8 h-8 object-contain"
          />
        </div>
          ...
          <div className="min-h-[70vh] w-full">
            ...
            >
              <div className="flex flex-col gap-[30px]">
                ...
                <ul className="grid grid-cols xl:grid-cols-2 gap-y-6 max-w-[620px] mx-auto xl:mx-0">
